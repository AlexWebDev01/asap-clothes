...
export function* getSnapshotFromUserAuth(userAuth: User, additinalDetails?: AdditionalInformation) {
    try {
...
export function* signInAfterSignUp({ payload: { user, additinalDetails }}: SignUpSuccess ) {
